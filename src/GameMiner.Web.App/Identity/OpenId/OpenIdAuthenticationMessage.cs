...
namespace GameMiner.Web.App.Identity.OpenId
{
    ...
    public class OpenIdAuthenticationMessage
    {
        ...
        public OpenIdAuthenticationMessage(IDictionary<string, string> parameters)
        {
            if (parameters == null)
            {
        ...
        /// </summary>
        /// <param name="parameters">The parameters associated with the message.</param>
        public OpenIdAuthenticationMessage(IEnumerable<KeyValuePair<string, StringValues>> parameters)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
